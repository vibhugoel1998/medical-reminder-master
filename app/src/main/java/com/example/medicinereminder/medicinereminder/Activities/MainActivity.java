...
import com.example.medicinereminder.medicinereminder.MyService;
...
//==================================================== Select Time =============================================================
    ...
    public void setAlarm(final long timeInMillis, String task)
    {
...
//        Log.d("", "setAlarm: ");
        final PendingIntent pendingIntent = PendingIntent.getBroadcast(this, (int)timeInMillis, intent, PendingIntent.FLAG_ONE_SHOT);
        AlertDialog.Builder builder1 = new AlertDialog.Builder(MainActivity.this);
        builder1.setMessage("Choose repetition");
        ...
        builder1.setNegativeButton("Set For each week", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                manager.setInexactRepeating(AlarmManager.RTC_WAKEUP, timeInMillis, 7*AlarmManager.INTERVAL_DAY, pendingIntent);
                Date date = new Date(timeInMillis);
                Log.d("Date:", date.toString());
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                    manager.setExactAndAllowWhileIdle(AlarmManager.RTC_WAKEUP, timeInMillis, pendingIntent);
    ...
    public void addNew(String task,Long timeinMillis,String date,String time) {
        ...
        String s3 = date;
        String s4 = time;
        dbHelp.addData(s1,s2,s3,s4,"yes");
        getData();
    }

    public void getData()
    {
        Cursor cursor=dbHelp.fetchData1();
...
/*AlertDialog.Builder builder1 = new AlertDialog.Builder(MainActivity.this);
            builder1.setMessage("Analysis Res");
            builder1.setCancelable(true);
